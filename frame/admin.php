...
<div>
   ...
   <p><code><pre><?php echo htmlspecialchars('<a data-product_id="[POST_ID]" class="[add-to-cart] [product_type] [Any other class but not add_to_cart_button]" data-quantity="[quantity]" [*]>[*]</a>') ?></pre></code>
   </p>
